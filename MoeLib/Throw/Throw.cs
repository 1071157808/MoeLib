...
// Project          : MoeLib
// Author           : Siqi Lu
// Created          : 2015-05-30  11:28 PM
//
// Last Modified By : Siqi Lu
// Last Modified On : 2015-05-30  11:28 PM
// ***********************************************************************
// <copyright file="Throw.cs" company="Shanghai Yuyi Mdt InfoTech Ltd.">
...
namespace Moe.Lib
{
    ...
    public static class Throw
    {
        ...
        {
            string exceptionMessage = numberOfElements == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.CollectionShouldContainLessThan1Element, additionalMessage, objectName)
        ...
        {
            string exceptionMessage = numberOfElements == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.CollectionShouldContainMoreThan1Element, additionalMessage, objectName)
        ...
        {
            string exceptionMessage = numberOfElements == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.CollectionShouldContain1Element, additionalMessage, objectName)
        ...
        {
            string exceptionMessage = numberOfElements == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.CollectionShouldNotContainLessThan1Element, additionalMessage, objectName)
        ...
        {
            string exceptionMessage = numberOfElements == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.CollectionShouldNotContainMoreThan1Element, additionalMessage, objectName)
        ...
        {
            string exceptionMessage = numberOfElements == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.CollectionShouldNotContain1Element, additionalMessage, objectName)
        ...
        {
            string exceptionMessage = minLength == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.StringShouldBeLongerThan1Character, additionalMessage, objectName)
        ...
        {
            string exceptionMessage = maxLength == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.StringShouldBeShorterOrEqualTo1Character, additionalMessage, objectName)
        ...
        {
            string exceptionMessage = maxLength == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.StringShouldBeShorterThan1Character, additionalMessage, objectName)
        ...
        {
            string exceptionMessage = length == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.StringShouldBe1CharacterLong, additionalMessage, objectName)
        ...
        {
            string exceptionMessage = length == 1 ? GetFormattedExceptionMessage(ExceptionMessagesManager.StringShouldNotBe1CharacterLong, additionalMessage, objectName)
