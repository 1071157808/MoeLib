...
// ***********************************************************************
// <copyright file="EnsuresExtensions.Compare.Int32.cs" company="Shanghai Yuyi">
...
namespace Moe.Lib
{
    ...
    public static partial class EnsuresExtensions
    {
        ...
        /// <param name="maxValue">The highest valid value.</param>
        /// <returns>The specified <paramref name="ensures" /> instance.</returns>
        public static Ensures<int> IsLessOrEqual(this Ensures<int> ensures, int maxValue)
        {
        ...
        /// <param name="minValue">The highest invalid value.</param>
        /// <returns>The specified <paramref name="ensures" /> instance.</returns>
        public static Ensures<int> IsNotLessOrEqual(this Ensures<int> ensures, int minValue)
        {
            return ensures.That(v => v > minValue);
        }
